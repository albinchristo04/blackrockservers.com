...
export default async function BudgetServersPage() {
    const allServers = await getServers();
    const budgetServers = allServers.filter(s => s.category === 'budget');
            ...
            <section className="py-20 bg-gradient-to-b from-gray-900 to-black">
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl mx-auto text-center">
                        <div className="inline-block px-4 py-2 rounded-full bg-green-500/10 text-green-400 text-sm font-semibold mb-6">
                            Starting at ${budgetServers.length > 0 ? Math.min(...budgetServers.map(s => s.price)) : '15'}/month
                        </div>
                        <h1 className="text-5xl md:text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-green-400 to-blue-600 mb-6">
                            Budget Dedicated Servers
                        </h1>
                        <p className="text-xl text-gray-400 mb-8">
                            Affordable bare metal servers perfect for development, testing, and small-scale production workloads. Get enterprise hardware at budget-friendly prices.
                        </p>
                ...
                <div className="container mx-auto px-4">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div className="text-center p-6">
                            ...
                            <p className="text-gray-400 text-sm">Premium hardware at unbeatable prices</p>
                        </div>
                        <div className="text-center p-6">
                            ...
                            <p className="text-gray-400 text-sm">Deploy in minutes, not hours</p>
                        </div>
                        <div className="text-center p-6">
            ...
            <section className="py-20 border-t border-gray-900">
                <div className="container mx-auto px-4">
                    <div className="text-center mb-12">
                        <h2 className="text-4xl font-bold text-white mb-4">Available Budget Servers</h2>
                        <p className="text-gray-400 text-lg">{budgetServers.length} servers available</p>
                    </div>
                    {budgetServers.length > 0 ? (
                        ...
                        <div className="text-center py-12">
                            <p className="text-gray-400">No budget servers available at the moment. Check back soon!</p>
                        </div>
                    )}
                </div>
            </section>
